...
final class PresupuestoPrintView implements ClientDocumentPrintViewInterface
{
    use PrintViewFormattingTrait;

    /** @var (callable(int): (\FSFramework\model\presupuesto_cliente|false))|null */
    private static $documentResolver = null;

    /** @var (callable(\FSFramework\model\presupuesto_cliente): array<string, mixed>)|null */
    ...
    private function __construct(
        private readonly \FSFramework\model\presupuesto_cliente $presupuesto,
    ...
    /** @param callable(int): (\FSFramework\model\presupuesto_cliente|false)|null $documentResolver */
    ...
    {
        return (int) $this->presupuesto->idpresupuesto;
    }
    ...
    {
        return self::formatMoney($this->divisa, $this->locale, (float) $this->presupuesto->total);
    }

    public function getSubtotalFormatted(): string
    {
        return self::formatMoney($this->divisa, $this->locale, (float) $this->presupuesto->neto);
    }
    ...
    /** @return \FSFramework\model\presupuesto_cliente|false */
    private static function resolveDocument(int $id): \FSFramework\model\presupuesto_cliente|false
    {
        ...
        return (new \FSFramework\model\presupuesto_cliente())->get((string) $id);
    }

    private static function build(\FSFramework\model\presupuesto_cliente $presupuesto): self
    {
        if (self::$relatedResolver !== null) {
            $related = (self::$relatedResolver)($presupuesto);
    ...
    {
        if (!class_exists(\FSFramework\model\presupuesto_cliente::class, false)) {
